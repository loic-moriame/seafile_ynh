...
install_dependance() {
	ynh_install_app_dependencies python3.5 python-pip libpython3.5 python-setuptools python-ldap python-urllib3 python-simplejson python-imaging python-mysqldb python-flup expect python-requests python-dev ffmpeg python-memcache \
